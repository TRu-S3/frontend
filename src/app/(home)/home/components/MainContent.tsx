...
import { Star, MoreHorizontal, Calendar as CalendarIcon, ChevronLeft, ChevronRight } from 'lucide-react';
...
const users = [
  {
    ...
    intro: "こんにちは！私は手羽太郎です！ハッカソンに一緒に出てくれる仲間を探しています！ぜひ、ZennのAIエージェントハッカソンに一緒に出ましょう！優勝目指すぞ！",
    projects: [
      { label: "技術ブログ", url: "#" },
      { label: "GitHub", url: "#" }
    ],
    ...
    <section className="flex flex-col items-center px-2 py-6 gap-6">
      <Tabs defaultValue="similar" className="w-full max-w-2xl">
        <TabsList className="w-full flex">
          ...
          <TabsTrigger value="wanted" className="flex-1">求めているユーザー</TabsTrigger>
          <TabsTrigger value="generation" className="flex-1">同世代のユーザー</TabsTrigger>
        </TabsList>
